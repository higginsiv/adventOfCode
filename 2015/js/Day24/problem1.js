...
function getCombinations(arr, currentWeight, buckets, bucketIndex, goalWeight, visited, furthestInBucket) {
        ...
        if (potentialWeight < goalWeight) {
            ...
            if (bucketIndex === 1) {
                ...
                if (bucketIndex === 0) {
                    ...
                    bestToGoalWeight = Math.min(bestToGoalWeight, newBuckets[0].toString(2).match(/1/g).length);
                ...
                getCombinations(arr, 0, newBuckets, bucketIndex + 1, goalWeight, visited | bitmasks.get(curr), 0);
            }
        } 
    };
}
