...
const [BOSS_HEALTH, BOSS_DAMAGE] = fr.getInput(YEAR, DAY).map((x) => parseInt(x.split(': ')[1]));
...
class State {
  ...
  armor;
  manaSpent;
  constructor(player, boss, mana, shieldTurns, poisonTurns, rechargeTurns, next, armor, manaSpent) {
    this.player = player;
    this.boss = boss;
    this.mana = mana;
