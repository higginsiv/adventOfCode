...
const [BOSS_HEALTH, BOSS_DAMAGE, BOSS_ARMOR] = fr.getInput(YEAR,DAY).map(x => parseInt(x.split(': ')[1]));

const HEALTH = 100;

const WEAPONS = [[8,4,0],[10,5,0],[25,6,0],[40,7,0],[74,8,0]];
const ARMOR = [[0,0,0],[13,0,1],[31,0,2],[53,0,3],[75,0,4],[102,0,5]];
        ...
        RINGS.forEach(r1 => {
            RINGS.forEach(r2 => {
                if(r1[0] !== r2[0]) {
                    ...
                    let playerTurnsToKill = Math.ceil(BOSS_HEALTH / Math.max(1, damage - BOSS_ARMOR));
