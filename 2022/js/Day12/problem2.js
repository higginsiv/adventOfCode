...
const [startCharCode, goalCharCode] = ['S'.charCodeAt(0) - minCharCode, 'E'.charCodeAt(0) - minCharCode];
...
const data = fr.getInput(year,day).map((line, x) => line.split("").map((char, y) => {
